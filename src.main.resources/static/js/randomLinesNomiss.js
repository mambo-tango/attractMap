...
// 		    [{name:'广州',value:100}, {name:'银川'}],
 	 	...
 	 	BJData = [
  	 	...
  	 	BJData = [
   	 	...
   	 	BJData = [
   		    [{name:'北京',value:100}, {name:'贵阳'}],[{name:'兰州',value:100}, {name:'鄂尔多斯'}]
   		];
   	}
 	 else if(result == '15'){
   	 	BJData = [
...
//		
//		console.info(data0.shift());
//		console.info(data1.shift());
//		console.info(data2.shift());
...
// 	console.info("BJData length:"+BJData.length)
...
var websocket = null;
 ...
 if('WebSocket' in window){
     websocket = new WebSocket("ws://192.168.20.145:8081/websocket");
 }
 else{
